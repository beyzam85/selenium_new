 ...
 */
        String dosyaYolu = "C:\\Users\\ASUS\\Desktop\\email validation"; //   \\ ikili olmalı
        //System.out.println(Files.exists(Paths.get(dosyaYolu)));
        Assert.assertTrue(Files.exists(Paths.get(dosyaYolu)));//dosya orada mı diye kontrol ediyor
        /*
