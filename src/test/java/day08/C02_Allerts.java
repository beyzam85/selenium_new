...
tıklayın ve result mesajında isminizin görüntülendiğini doğrulayın.
    ...
    public void test3() throws InterruptedException {
        ...
        driver.switchTo().alert().sendKeys("Erol Evren");//METNİ GONDERDİM
        driver.switchTo().alert().accept();//ACCEPT İLE TAMAM A BASTIRDIM
        String actualMesaj = driver.findElement(By.xpath("//*[@id='result']")).getText();//KODU STRİNGE ATADIM GET TEXT İLE
        String expectedMesaj = "Erol Evren";
        Assert.assertTrue(actualMesaj.contains(expectedMesaj));//yukarıda yazdıgım ismi exepted da içeriyor mu içermiyormu test ettim
