...
6- Tüm dropdown değerleri(option) yazdırın
7- Dropdown'un boyutunu bulun, Dropdown'da 4 öğe varsa konsolda True , degilse False yazdırın.
  */
    ...
    public void test1() {
        ...
        System.out.println(select.getFirstSelectedOption().getText());//select objesinden bir onceki sectiğimizi getir demek
        ...
        for (WebElement each :tumOpsiyonlar    //biz WebElementlerle ugrasıyoruz adı each olsun bu webElenmentler tumOpsiyonlardan gelecek
        ) {
            System.out.println(each.getText());//her bir elementin uzerindeki text ti yazdırıcam
        }
        //7- Dropdown'un boyutunu bulun, Dropdown'da 4 öğe varsa konsolda True , degilse False yazdırın.
